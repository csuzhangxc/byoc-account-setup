...
1. **Parameters**
   ...
   `tidbcloud-byoc-setup.sh` requires 5 parameters:
...
2. **Run Script**
   ...
   ```bash
   bash tidbcloud-byoc-setup.sh <ControlPlaneAccountId> <ClinicAccountId> <TidbHostedZoneId> <O11yHostedZoneId> <TidbPCAArn>
   ```
